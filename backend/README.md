...
## Project Structure
    ...
    ├── base_delivery_templ_37890  # Django project configurations
...
1. Clone this repo and `cd base_delivery_templ_37890`
...
2. Clone this repo and `cd base_delivery_templ_37890`
